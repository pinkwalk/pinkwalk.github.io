...
export const partnershipCategories: PartnershipTypeOption[] = [
  ...
  },
  {
    ...
    description:
      "Provide health checkups, screening camps, or emergency medical support.",
  },
  {
    id: "logistics",
    label: "Logistics & Venue",
    description:
      "Support sound systems, staging, signage, security, or route management.",
  },
  {
    id: "merchandise",
    label: "Refreshment & Merchandise",
    description:
      "Sponsor official PinkWalk t-shirts, drinking water, snacks, or caps.",
  },
  {
    id: "corporate",
    label: "Corporate & Financial Sponsor",
    description:
      "Provide financial sponsorship or corporate CSR participation.",
  },
  {
    id: "community",
    label: "Community & NGO Partner",
    description:
      "Mobilize volunteer groups, youth clubs, or community networks.",
  },
  {
    id: "other",
    label: "Other Contribution",
    description:
      "Have another unique way to support or collaborate with PinkWalk?",
  },
];
